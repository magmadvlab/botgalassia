export const activities_it = {
  ...
  keywords: [
    ...
    'prato nevoso', 'escursioni', 'shopping', 'relax', 'riposo',
    'rilassamento', 'pausa', 'tempo libero', 'motoslitta',
    'vista', 'monti innevati', 'bar', 'spettacoli', 'serate', 'conca',
    'negozi', 'sport', 'inverno', 'estate', 'prodotti tipici',
    'cosa fare in hotel', 'sala relax', 'cosa posso fare', 'attività in albergo',
    'sala biliardo', 'calcio balilla', 'zona relax', 'area riposo'
  ],
  questions: {
    ...
    'Cosa offre la sala relax?': {
      ...
      tags: [
        ...
        'cosa fare in sala relax?', 'posso prendere qualcosa al bar?', 'bar con vista',
        'area riposo', 'zona relax con bar'
      ]
    },
    'Dove si trova la sala giochi?': {
      ...
      tags: [
        ...
        'cosa posso fare nella sala giochi?', 'attività sala giochi', 'sala giochi hotel',
        'relax', 'riposo', 'divertimento'
      ]
    },
    'Posso prendere qualcosa al bar?': {
      ...
      tags: [
        ...
        'zona relax', 'riposo', 'rilassamento', 'pausa'
      ]
    },
