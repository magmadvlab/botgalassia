export const checkinFAQ_IT = {
  ...
  keywords: [
    ...
    'presto', 'tardi', 'tempo', 'bagagli', 'valigie', 'borse', 'deposito', 
    'oggetti', 'arrivo', 'partenza', 'lasciare', 'ritirare', 'depositare', 
    'camera', 'stanza', 'reception', 'hall', 'dove', 'come', 'quale', 
    'quanto', 'possibile', 'prima', 'dopo', 'anticipato', 'ritardo', 'tardi'
  ],
  questions: {
    // SEZIONE ORARI BASE
    'A che ora posso fare il check-in?': {
      ...
      tags: ['check-in', 'orari', 'arrivo', 'quando']
    },
    'Quando posso entrare in camera?': {
      ...
      tags: ['camera', 'orari', 'entrata', 'check-in', 'bagagli']
    },
    ...
    'A che ora devo lasciare la stanza?': {
      ...
      tags: ['check-out', 'camera', 'orari', 'partenza']
    },
    'Posso tenere la camera più a lungo?': {
      ...
      tags: ['check-out', 'ritardo', 'supplemento', 'orari', 'partenza']
    },
    ...
    'Posso arrivare prima del check-in?': {
      ...
      tags: ['arrivo', 'anticipato', 'bagagli', 'check-in']
    },
    'Cosa devo fare se arrivo tardi?': {
      ...
      tags: ['arrivo', 'tardi', 'ritardo', 'check-in']
    },
    'Dove posso lasciare i bagagli?': {
      ...
      tags: ['bagagli', 'deposito', 'custodia', 'check-in', 'check-out']
    },
    ...
    'Cosa serve per il check-in?': {
      ...
      tags: ['check-in', 'documenti', 'procedure', 'pagamenti']
    },
