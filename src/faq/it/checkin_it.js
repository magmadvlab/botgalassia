export const checkinFAQ_IT = {
  ...
  questions: {
    'A che ora posso fare il check-in?': {
      ...
      tags: ['check-in', 'orari', 'arrivo', 'quando', 'tempo', 'inizio']
    },
    'Quando posso entrare in camera?': {
      ...
      tags: ['camera', 'orari', 'entrata', 'check-in', 'bagagli', 'registrazione']
    },
    'A che ora devo lasciare la stanza?': {
      ...
      tags: ['check-out', 'camera', 'orari', 'partenza', 'uscita', 'fine']
    },
    'Posso tenere la camera più a lungo?': {
      ...
      tags: ['check-out', 'ritardo', 'supplemento', 'orari', 'partenza', 'tardi']
    },
    ...
    'Dove posso lasciare i bagagli?': {
      ...
      tags: ['bagagli', 'deposito', 'custodia', 'check-in', 'check-out', 'oggetti']
    },
    'Cosa serve per il check-in?': {
      ...
      tags: ['check-in', 'documenti', 'procedure', 'pagamenti', 'registrazione']
    },
