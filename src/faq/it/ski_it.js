export const skiFAQ_IT = {
  ...
  keywords: [
    ...
    // Piste e attività
    'pista', 'piste', 'neve', 'skipass', 'sci notturno', 'sciare', 'piste illuminate',
    'dove sono le piste', 'orari piste', 'piste notturne', 'comprensorio sci',
    // Servizi
    'noleggio', 'scuola sci', 'maestro', 'principiante', 'imparare', 'lezioni',
    'navetta', 'trasporto', 'conca', 'prenotare', 'lezioni private',
    // Luoghi
  ...
  questions: {
    'Dove si trovano gli ski box?': {
      ...
      tags: ['ski box', 'attrezzatura', 'deposito', 'posizione', 'dove stanno gli ski box?', 'dove trovo gli ski box?', 'dove si trovano gli armadietti?', 'sci riscaldati']
    },
    'Come funzionano gli ski box?': {
      ...
      tags: ['ski box', 'funzionamento', 'riscaldamento', 'come funzionano gli ski box?', 'come si usano gli armadietti?', 'uso degli ski box?', 'come funzionano i depositi?']
    },
    'Gli ski box sono riscaldati?': {
      ...
      tags: ['ski box', 'riscaldamento', 'asciugatura', 'ski box riscaldati?', 'gli armadietti sono riscaldati?', 'c\'è riscaldamento per gli sci?', 'sci riscaldati']
    },
    'Dove posso lasciare gli sci?': {
      ...
      tags: ['deposito', 'ski box', 'attrezzatura', 'dove lasciare gli sci?', 'dove mettere gli sci?', 'deposito sci?', 'dove posso riporre gli sci?']
    },
    'Dove posso noleggiare l\'attrezzatura da sci?': {
      ...
      tags: ['noleggio', 'sci', 'snowboard', 'attrezzatura', 'sconto', 'dove noleggiare sci?', 'dove si affitta attrezzatura?', 'noleggio attrezzatura']
    },
    'Ci sono scuole di sci disponibili?': {
      ...
      tags: ['scuola sci', 'lezioni', 'maestri', 'imparare', 'principianti', 'dove sono le scuole di sci?', 'posso prenotare lezioni sci?', 'maestro di sci']
    },
    'È possibile acquistare lo skipass in hotel?': {
      ...
      tags: ['skipass', 'piste', 'acquisto', 'posso comprare skipass in hotel?', 'dove compro skipass?', 'acquisto skipass hotel?', 'biglietto piste']
    },
    'Ci sono piste illuminate per lo sci notturno?': {
      ...
      tags: ['sci notturno', 'piste illuminate', 'orari', 'quando c\'è lo sci notturno?', 'ci sono piste notturne?', 'posso sciare di notte?', 'piste illuminate orari']
    }
  }
};
