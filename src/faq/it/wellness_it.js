export const wellnessFAQ_IT = {
  ...
  keywords: ['piscina', 'nuotare', 'bagno', 'wellness', 'spa', 'idromassaggio', 'relax', 'cuffia', 'prenotazione', 'come arrivare', 'dove', 'piano', 'arrivare'],
  questions: {
    'Come funziona l\'accesso alla piscina?': {
      ...
      tags: ['piscina', 'accesso', 'orari', 'requisiti', 'come arrivare', 'dove si trova', 'come arrivo', 'come arrivo in', 'raggiungo', 'arrivare', 'piano', 'ascensore', 'scale']
    },
    'Dove si trova la piscina?': {
      ...
      tags: ['piscina', 'posizione', 'dove', 'come arrivare', 'piano', 'ascensore', 'scale']
    },
